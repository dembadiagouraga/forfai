...
class EmailSendService extends CoreService
{
    ...
    public function emailBaseAuth(?EmailTemplate $emailTemplate, User $user): PHPMailer
    {
        ...
        // Using environment variables directly instead of EmailSetting model
        ...
        $mail->setFrom(env('MAIL_FROM_ADDRESS', $mail->Username), env('MAIL_FROM_NAME', 'Forfai Marketplace'));
        $mail->addAddress($user->email, $user->firstname);

        try {
            // Recipient already added above
