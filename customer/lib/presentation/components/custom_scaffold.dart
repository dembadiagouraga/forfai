...
import 'package:quick/presentation/pages/no_internet/no_internet.dart';
...
class CustomScaffold extends StatefulWidget {
  ...
  final bool resizeToAvoidBottomInset; // Added parameter for keyboard behavior
  ...
  const CustomScaffold({
    ...
    this.resizeToAvoidBottomInset = false, // Default to false to maintain current behavior
  });
