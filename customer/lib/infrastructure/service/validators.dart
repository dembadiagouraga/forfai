...
abstract class AppValidators {
  ...
  static String? emptyCheck(String? title) {
  ...
  static String? isMin12Symbol(String? title) {
    if (title?.isEmpty ?? true) {
      return AppHelpers.getTranslation(TrKeys.thisFieldIsRequired);
    } else if ((title?.length ?? 0) < 12) {
      return AppHelpers.getTranslation(TrKeys.thisFieldMinSymbol);
    }
    return null;
  }
